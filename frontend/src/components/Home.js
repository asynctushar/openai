    ...
    return (
        <div className="flex items-center justify-center flex-col mt-10 text-left">
            ...
            <Input.Group compact className="w-10/12 sm:w-96">
                <Input onKeyUp={(e) => e.key === 'Enter' && onSubmit()} placeholder="Enter your message" className="placeholder:text-zinc-700 !w-8/12 h-12" value={message} onChange={(e) => setMessage(e.target.value)} />
